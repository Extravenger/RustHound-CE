...
| RustHound.exe         | Windows <img width="20px"  src="https://github.com/g0h4n/RustHound-CE/raw/main/img/windows.png"/> | ~3500   | **~5.315s**  | Measure-Command { nonehound.exe -d essos.local -u khal.drogo@essos.local -p horse -z } | 
| RustHound         | Linux <img width="20px"  src="https://github.com/g0h4n/RustHound-CE/raw/main/img/linux.png"/>    | ~3500   | **~3.166s**  | time nonehound -d essos.local -u khal.drogo@essos.local -p horse -z  |
